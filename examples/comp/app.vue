    ...
    <div class="main">
            ...
            <div class="main-banner-title">
                ...
                <span class="main-banner-title-items">
                    <!-- <a class="main-banner-title-item" href="https://github.com/huangshuwei/vue-easytable">
                        <i class="icon iconfont icon-github"></i>&nbsp;&nbsp;repo
                        </a> -->
                    <a class="main-banner-title-item" href="https://github.com/huangshuwei/vue-easytable/releases">
                        <i class="icon iconfont icon-gengxinrizhi"></i>&nbsp;&nbsp;update Daily</a>
                </span>
            </div>
        </div>
            ...
            <div class="main-wrapper-sidebar">
                <ul class="menu-root">
                    <li>
                        ...
                        <a class="main-wrapper-sidebar-link" href="javascript:javascript:void(0);">table plugin</a>
                        <ul class="menu-sub">
                            <!-- <li>
                            ...
                            <li>
                                <router-link to="/table/cellEdit">cell Edit</router-link>
                            </li>
                            <!-- <li>
        ...
        <div class="main-footer">
            <div>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <span>Created by <a href="https://github.com/huangshuwei">MichaelOu</a></span>
            </div>
        </div>
